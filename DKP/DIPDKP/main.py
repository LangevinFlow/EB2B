                ...
                for j in range(len(D_loops)):
                    ...
                    for k in range(len(datasets)):
                        ...
                        for i in range(len(methods)):
                            ...
                            prog.add_argument('--kernel_source', type=str, default='mcmc', choices=['mcmc', 'resnet', 'eb'],
                                              help='Choose kernel source: mcmc, resnet, or eb.')
                            prog.add_argument('--eb_lr', type=float, default=1e-3,
                                              help='Learning rate for Empirical Bayes optimization')
                            prog.add_argument('--eb_steps', type=int, default=100,
                                              help='Number of optimization steps for Empirical Bayes')
                            prog.add_argument('--eb_prior_weight', type=float, default=0.1,
                                              help='Weight for the prior term in Empirical Bayes')
                            prog.add_argument('--max_iters', type=int, default=1000,

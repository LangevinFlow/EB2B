...
class Config:
    def __init__(self):
        ...
        # Iterations
        self.parser.add_argument('--max_iters', type=int, default=800, help='# of iterations')
        ...
        self.parser.add_argument('--kernel_source', type=str, default='mcmc', choices=['mcmc', 'resnet', 'eb'],
                                help='Choose kernel source: mcmc, resnet, or eb.')

    def parse(self, args=None):
        """Parse the configuration"""  # 解析配置
        self.conf = self.parser.parse_args(args=args)    # 解析参数
        self.set_gpu_device()
